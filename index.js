...
program
    ...
    .option('-r --region [value]', 'AWS Region [value]', 'value');
...
program.command('query [value]')
    ...
    .action(function (value) {
        ...
        var aws_region = (program.region.value !== undefined) ? program.region.toLowerCase().trim() : 'eu-west-1'; //todo make this an option param
